...
- **eventos_conductores** se construye en `ensamblar_eventos_conductores`: por cada evento en `eventos_bus` se asigna **un** conductor y se añade **un** evento (Vacio/Parada/Comercial). No se crean eventos nuevos; solo se asigna conductor.
