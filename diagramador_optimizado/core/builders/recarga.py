...
def _buscar_oportunidad_recarga(
    ...
    for deposito_obj in gestor.depositos_config:
        ...
        # Calcular tiempo actual aproximado (necesitaríamos el tiempo real del último evento)
        tiempo_actual_aprox = 0  # Se ajustará cuando se use
        llegada_deposito_aprox = tiempo_actual_aprox + tiempo_ida
        ...
        recarga_info = _calcular_recarga_disponible(
            ...
            llegada_deposito_aprox + tiempo_para_recarga,
